@section("popups")
<!-- for Login  Modal -->
<div class="modal" id="ModalLogin" role="dialog" tabindex=-"1">
    <div class="modal-dialog" >
        <div class="modal-content">
            <form name="login" class="login" id="loginForm" role="form" method="post" action="#" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="sign_up_opt">
                        Not a member yet? <a href="#" data-toggle="modal" data-target="#ModalSignup" data-dismiss="modal">Sign Up</a>
                    </div>
