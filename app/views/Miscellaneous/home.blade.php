    ...
    <div class="main wrapper clearfix">
		...
		<main class="clearfix">
			<h1 style="padding-top:10px;">
					...
					<div class="item">
						...
						<section class="img-text">
							<p>
								...
								Financial Genius Ankit Gupta on what Modi has done &#38; should do in FY 2015. <strong>The most simple yet profound analysis.</strong>
							</p>
						</section>
					</div>
					<div class="item">
				...
				INDIA'S FIRST ENTREPRENEURSHIP PLATFORM  IS HERE
			</h1>
        	<p>
        		<div class="col-lg-4">
        			<div class="panel">
